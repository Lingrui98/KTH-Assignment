...
out_size = 10
in_size = 3072
m_nodes = [in_size,50,50,out_size]
rho = 0.99
...
class Classifier(object):
    ...
    def __init__(self, n_layers, m_nodes, rho, eta=0.1, lamda=0, epoch=100, batch_size=batch_size, reader=None):
...
if __name__=="__main__":
    ...
    c = Classifier(n_layers,m_nodes,rho,eta,lamda,epoch,reader=dr)
